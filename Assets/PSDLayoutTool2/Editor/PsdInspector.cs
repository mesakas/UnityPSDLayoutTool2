    ...
    public class PsdInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            if (nativeEditor != null)
            {
                ...
                {
                    GUILayout.Label("<b>PSD Layout Tool 2</b>", guiStyle, GUILayout.Height(23));
                    ...
                    GUIContent outputModeLabel = new GUIContent("Output Mode", "Where generated files are saved.");
                    PsdImporter.OutputMode = (PsdImporter.OutputDirectoryMode)EditorGUILayout.EnumPopup(outputModeLabel, PsdImporter.OutputMode);

                    GUIContent outputFolderNameLabel = new GUIContent("Output Folder Name", "Folder name for generated files. Leave empty to use the PSD file name.");
                    PsdImporter.OutputFolderName = EditorGUILayout.TextField(outputFolderNameLabel, PsdImporter.OutputFolderName);

                    GUIContent prefabModeLabel = new GUIContent("Prefab Output", "Where the generated prefab is saved.");
                    PsdImporter.PrefabMode = (PsdImporter.PrefabOutputMode)EditorGUILayout.EnumPopup(prefabModeLabel, PsdImporter.PrefabMode);
